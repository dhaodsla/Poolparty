...
export function Home() {
  ...
  }, [currentLineIdx, currentCharIdx, introFinished, introStarted]);
        ...
        {!introFinished && (
          ...
          >
            {!introStarted ? (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-brand-accent/5 flex items-center justify-center mb-2">
                ...
                <h2 className="text-xl font-serif text-brand-text mb-2">STAY YEON POOL PARTY</h2>
                <button 
                  onClick={startIntro}
                  className="px-8 py-3 bg-brand-accent text-white rounded-full font-serif font-bold tracking-widest text-sm hover:bg-brand-accent/90 transition-colors shadow-md"
                >
                  초대장 열기
                </button>
              </motion.div>
